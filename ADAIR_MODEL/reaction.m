...
global reox_start_time k1 km1 k2 ko1 kom1 ko2 kom2 ...
       ko3 kom3 ko4 kom4 dk_in dk_ref sorc AIR
...
reaction_2 = k2*EO;
reaction_3 = ko1*HO4-kom1*O*HO3;
reaction_4 = ko2*HO3-kom2*O*HO2;
reaction_5 = ko3*HO2-kom3*O*HO;
reaction_6 = ko4*HO-kom4*O*H;
