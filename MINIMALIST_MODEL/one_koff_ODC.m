...
function Product_matrix_one_koff = one_koff_ODC(U,Time_vector,Product_vector, ...
...
[~,Product_matrix_one_koff] = ode15s(@(t,s) reaction_local(t,s,reox_start_time, km1, k2, kt_on, kt_off, ...
    dk_ref, sorc, AIR),Time_vector,Reactant_vector,options);
